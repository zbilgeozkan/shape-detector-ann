...
with open("data/shape_data.csv", mode="w", newline="") as file:
    ...
    writer.writerow(["area", "perimeter", "circularity", "label"])  # Başlıkları yaz
    ...
    while True:
        ...
        edged = cv2.Canny(gray, 50, 150)  # Kenarları bulmak için Canny algoritması
        ...
        for cnt in contours:
            ...
            # Şekli tanımla (Circle, Square, Triangle vb.)
